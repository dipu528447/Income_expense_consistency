      ...
      <div className="container mx-auto max-w-6xl text-center drop-shadow-lg text-gray-800">
        <userContext.Provider value={[user,setUser,transaction,setTransaction]}>
            <Routes>
                ...
                <Route path="/ExpenseTracker" element={<PrivateRoute><ExpenseTracker></ExpenseTracker></PrivateRoute>}/>
                <Route path="/admin" element={<PrivateRoute><AdminPanel/></PrivateRoute>}/>
                <Route path="/goldPrice" element={<PrivateRoute><GoldPrice/></PrivateRoute>}/>
                <Route path="/newFeature" element={<PrivateRoute><NewFeature/></PrivateRoute>}/>
